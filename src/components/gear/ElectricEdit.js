...
export default class ElectricEdit extends Component {
   ...
   state = {
    ...
    createElectricPost = evt => {
        ...
        this.props.editElectric(newElectricPost, this.state.id, "electrics").then(() => this.props.history.push("/gear"))
    }
        ...
        return (
            <React.Fragment>
                ...
                <form className="electricForm">
                    ...
                    <div className="form-group">
                        <label htmlFor="electricGuitarPickups" className="electricGuitarPickups">Strings:</label>
                        <input type="text" required="true"
